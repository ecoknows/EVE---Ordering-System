...
namespace ProjectEve {
	...
	/// <summary>
	/// Summary for AboutJayson
	/// </summary>
	public ref class AboutJayson : public System::Windows::Forms::UserControl
	{
	public:
		AboutJayson(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(AboutJayson::typeid));
			...
			this->label10->Text = L"If opportunity doesn’t knock, build a door.";
			// 
			// label9
			// 
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Lucida Calligraphy", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(546, 103);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Lucida Calligraphy", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(546, 243);
			...
			this->label4->Text = L"Quezon City";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Jayson T. Laña";
			// 
			// label7
			// 
