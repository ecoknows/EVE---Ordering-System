...
namespace ProjectEve {
	...
	/// <summary>
	/// Summary for AboutRoxie
	/// </summary>
	public ref class AboutRoxie : public System::Windows::Forms::UserControl
	{
	public:
		AboutRoxie(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(AboutRoxie::typeid));
			...
			this->label10->Text = L"Life is unfair, get used to it.";
			// 
			// label9
			// 
			...
			this->label9->Text = L"Tondo, Manila";
			// 
			// label6
			// 
			...
			this->label2->Text = L"Ma. Roxann T. Cacho";
			// 
			// label7
			// 
